...
US_SERIES = [
    ...
    dict(id="us-cpi", series="CPIAUCNS", name="CPI 年增率", category="inflation", unit="%", changeUnit="百分點", frequency="月", source="美國勞工統計局 BLS（FRED）", sourceUrl="https://fred.stlouisfed.org/series/CPIAUCNS", transform="yoy", periods=12, calendarMonths=12, digits=1, note="未季調、相對去年同月；與 BLS 新聞稿口徑一致"),
    dict(id="us-core-cpi", series="CPILFENS", name="核心 CPI 年增率", category="inflation", unit="%", changeUnit="百分點", frequency="月", source="美國勞工統計局 BLS（FRED）", sourceUrl="https://fred.stlouisfed.org/series/CPILFENS", transform="yoy", periods=12, calendarMonths=12, digits=1, note="未季調、相對去年同月；與 BLS 新聞稿口徑一致"),
