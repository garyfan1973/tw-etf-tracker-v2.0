(function () {
  ...
  const architectures = [
    ...
    },
    {
      ...
      focus:["compute","memory","foundry","packaging","network","cloud","security","software"],
      sources:[
  ...
  const stageResearch = {
    ...
    security:{value:"AI 讓資料、API、端點與非人類身分快速增加，安全平台的價值來自跨域遙測、即時政策與自動化回應。",bottleneck:"產品整合、誤報控制、資料主權、資安人才與既有工具遷移速度。",watch:"ARR／訂閱成長、淨留存、平台模組採用、SASE 流量、端點與工作負載數、事件復原時間。",risk:"平台整併壓低單點工具價格、重大服務中斷、漏洞責任、雲端與 AI 推論成本上升。",question:"成長是威脅增加帶來的席次擴張，還是平台整合真正提高每位客戶的長期價值？",sources:[["CrowdStrike Falcon 平台","https://www.crowdstrike.com/platform/"],["Palo Alto Networks 平台整合","https://www.paloaltonetworks.com/why-paloaltonetworks/platformization"],["Zscaler Zero Trust 平台","https://www.zscaler.com/products-and-services/zscaler-unified-platform"],["Trend Micro 企業資安平台","https://www.trendmicro.com/en/business.html"],["安碁資訊 SOC 服務","https://www.acercsi.com/tw/service/17"]]},
    software:{value:"模型只有接上資料、分發入口與可重複的付費工作流，才可能轉成持續性收入與平台黏著度。",bottleneck:"企業資料治理、模型成本、Agent 準確率、權限與既有流程整合，往往比模型展示更難。",watch:"AI 產品收入占比、付費席次與用量、Agent 任務完成率、資料雲消耗、推論毛利率、留存與交叉銷售。",risk:"功能快速商品化、雲端推論成本、錯誤責任、資料授權、客戶自建與平台綁定反彈。",question:"AI 功能帶來的是新收入、提高既有產品單價，還是只是維持競爭力所需的成本？",sources:[["Apple Intelligence","https://developer.apple.com/apple-intelligence/"],["Meta AI","https://ai.meta.com/meta-ai/"],["Palantir AIP","https://www.palantir.com/platforms/aip/"],["ServiceNow AI Platform","https://www.servicenow.com/products/ai.html"],["Snowflake Cortex AI","https://www.snowflake.com/en/product/features/cortex/"]]},
  };
  ...
  const scenarios = [
    ...
    {id:"cyber",title:"AI Agent 與資料攻擊面擴大",label:"安全支出上行",thesis:"AI Agent、API 與非人類身分快速增加，企業把資安預算從單點工具移向身分、雲端、SecOps 與資料韌性的整合平台。",assumptions:["企業 AI 從試驗進入正式工作流程","監管與客戶要求提高可稽核性","攻擊者同步利用 AI 加速社交工程與漏洞利用"],confidence:"中",direct:[["security","身分、XDR、SASE 與資料韌性"],["cloud","雲端工作負載與 AI 治理"]],indirect:[["network","流量檢查與安全閘道"],["system","韌體、BMC 與供應鏈驗證"]],pressure:[["cloud","合規與推論成本上升"],["system","部署與維運複雜度增加"]],companies:["usCRWD","usPANW","usFTNT","usZS","usNET","usOKTA","usRBRK","jp4704","tw6690"],caveat:"威脅升高不會自動轉成同等營收；平台折扣、競爭、事件責任與客戶整併工具都可能壓縮成長。"},
    {id:"software",title:"AI 從試用走向付費工作流",label:"軟體變現",thesis:"企業與消費平台把模型從聊天入口延伸到可執行任務的 Agent、裝置功能與正式工作流程，軟體價值開始由使用量、席次與成果衡量。",assumptions:["Agent 準確率與成本達到正式部署門檻","企業允許更多治理後資料供模型使用","平台能把 AI 功能轉成訂閱、用量、廣告或硬體需求"],confidence:"中",direct:[["software","Agent、資料平台與 AI 應用"],["cloud","推論與模型服務用量"]],indirect:[["security","身分、資料與 Agent 治理"],["compute","裝置端與雲端推論需求"]],pressure:[["software","同質化與推論毛利壓力"],["cloud","資本支出與價格競爭"]],companies:["usPLTR","usAAPL","usMETA","usMSFT","usGOOGL","usNOW","usCRM","usSNOW","usDDOG","usADBE","usORCL"],caveat:"產品使用量成長不等於高毛利新收入；免費綁售、模型商品化、導入週期與推論成本都可能稀釋變現。"}
  ];
